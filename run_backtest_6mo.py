"""Run 6-month backtests (Jul-Dec 2025) using test universes.

Usage:
    python run_backtest_6mo.py                  # both branches
    python run_backtest_6mo.py growth           # growth only
    python run_backtest_6mo.py value            # value only
"""
